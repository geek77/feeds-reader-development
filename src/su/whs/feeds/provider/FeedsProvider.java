...
public class FeedsProvider extends ContentProvider {
    ...
    public static final String AUTHORITY = "su.whs.feeds";
    public static final String CONTENT_URI_BASE = "content://" + AUTHORITY;

    public static final String QUERY_NOTIFY = "QUERY_NOTIFY";
    public static final String QUERY_GROUP_BY = "QUERY_GROUP_BY";

    private static final int URI_TYPE_FEEDS = 0;
    private static final int URI_TYPE_FEEDS_ID = 1;
    ...
    static {
        URI_MATCHER.addURI(AUTHORITY, FeedsColumns.TABLE_NAME, URI_TYPE_FEEDS);
        URI_MATCHER.addURI(AUTHORITY, FeedsColumns.TABLE_NAME + "/#", URI_TYPE_FEEDS_ID);
    }

    protected FeedsSQLiteOpenHelper mFeedsSQLiteOpenHelper;
    ...
    public boolean onCreate() {
        ...
        mFeedsSQLiteOpenHelper = FeedsSQLiteOpenHelper.getInstance(getContext());
        return true;
    }
    ...
    public String getType(Uri uri) {
        ...
        switch (match) {
            case URI_TYPE_FEEDS:
                return TYPE_CURSOR_DIR + FeedsColumns.TABLE_NAME;
            case URI_TYPE_FEEDS_ID:
                return TYPE_CURSOR_ITEM + FeedsColumns.TABLE_NAME;
    ...
    public Uri insert(Uri uri, ContentValues values) {
        ...
        long rowId = mFeedsSQLiteOpenHelper.getWritableDatabase().insertOrThrow(table, null, values);
    ...
    public int bulkInsert(Uri uri, ContentValues[] values) {
        ...
        String table = uri.getLastPathSegment();
        SQLiteDatabase db = mFeedsSQLiteOpenHelper.getWritableDatabase();
        int res = 0;
        db.beginTransaction();
        try {
    ...
    public int update(Uri uri, ContentValues values, String selection, String[] selectionArgs) {
        ...
        int res = mFeedsSQLiteOpenHelper.getWritableDatabase().update(queryParams.table, values, queryParams.selection, selectionArgs);
        String notify;
        if (res != 0 && ((notify = uri.getQueryParameter(QUERY_NOTIFY)) == null || "true".equals(notify))) {
            getContext().getContentResolver().notifyChange(uri, null);
        }
    ...
    public int delete(Uri uri, String selection, String[] selectionArgs) {
        ...
        QueryParams queryParams = getQueryParams(uri, selection, null);
        int res = mFeedsSQLiteOpenHelper.getWritableDatabase().delete(queryParams.table, queryParams.selection, selectionArgs);
        String notify;
        if (res != 0 && ((notify = uri.getQueryParameter(QUERY_NOTIFY)) == null || "true".equals(notify))) {
            getContext().getContentResolver().notifyChange(uri, null);
        }
    ...
    public Cursor query(Uri uri, String[] projection, String selection, String[] selectionArgs, String sortOrder) {
        ...
        Cursor res = mFeedsSQLiteOpenHelper.getReadableDatabase().query(queryParams.tablesWithJoins, projection, queryParams.selection, selectionArgs, groupBy,
    ...
    private QueryParams getQueryParams(Uri uri, String selection, String[] projection) {
        ...
        switch (matchedId) {
            case URI_TYPE_FEEDS:
            case URI_TYPE_FEEDS_ID:
                res.table = FeedsColumns.TABLE_NAME;
                res.tablesWithJoins = FeedsColumns.TABLE_NAME;
                res.orderBy = FeedsColumns.DEFAULT_ORDER;
                break;
